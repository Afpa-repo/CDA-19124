...
public class UpdateController implements Initializable {
    ...
    public void show_commercial(){
        ...
        if(val_type.isSelected()){  //si c'est un particulier
            lst_commercial = userDAO.List_role_user("parcom"); //récupère la liste des commerciaux pour particulier
        }else{
            lst_commercial = userDAO.List_role_user("procom");
        }
    ...
    public void valider(ActionEvent actionEvent) throws IOException {
        ...
        if(form_valid){ //si le formulaire est valide
            ...
            App.user_app.setRole("client");    //c'est un client
            if(val_type.isSelected()){   //si c'est un particulier
