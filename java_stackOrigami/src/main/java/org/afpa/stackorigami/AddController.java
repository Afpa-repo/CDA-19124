...
public class AddController implements Initializable {
    ...
    @FXML
    public ComboBox list_commercial;
    ...
    public void show_commercial(){
        ...
        /*crée la liste à afficher dans commercial
        String[] name_commercial = new String[lst_commercial.size()];   //liste des commerciaux à afficher
        int i=0;    //compteur pour la liste
        for (User user : lst_commercial) {
            name_commercial[i]=user.getSurname()+" "+user.getFirst_name();
        }*/

        /*
        for (User user : lst_commercial) {
            list_commercial.setItems(user.getSurname()+" "+user.getFirst_name());
        }*/

        //obs_list_commercial= (ObservableList<User>) list_commercial;
